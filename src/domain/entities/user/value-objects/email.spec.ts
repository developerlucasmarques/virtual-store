...
describe('Email Value Object', () => {
  it('Should return InvalidEmailError if email not provided', () => {
  ...
  it('Should return InvalidEmailError if email more than 63 characters on domain part', () => {
  ...
  it('Should remove the spaces at the beginning and at the end of the email', () => {
